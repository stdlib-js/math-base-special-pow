...
```javascript
pow = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-pow@v0.0.7-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-pow@v0.0.7-umd/browser.js"></script>
```
